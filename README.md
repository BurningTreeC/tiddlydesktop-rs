...
TiddlyDesktopRS supports running shell commands from within your wikis (desktop only) via the **TiddlyDesktop-RS Commands** plugin.
...
Or use the Plugin Installer from the landing page to install it.
